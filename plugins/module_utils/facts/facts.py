...
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.facts.interfaces import (  # NOQA
    InterfacesFacts,
)
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.facts.legacy import (  # NOQA
    Default,
    SoftwareInfo,
    SoftwareImages,
    HostName,
...
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.facts.vlans import (  # NOQA
    VlansFacts,
)
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.facts.vrfs import (  # NOQA
    VrfsFacts,
)
from ansible_collections.ansible.netcommon.plugins.module_utils.network.common.facts.facts import (  # NOQA
    FactsBase,
)
...
FACT_RESOURCE_SUBSETS = dict(
    vlans=VlansFacts, interfaces=InterfacesFacts, vrfs=VrfsFacts
)
