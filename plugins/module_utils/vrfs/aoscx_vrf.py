...
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.vrfs.aoscx_vrf_base import (  # NOQA
    VRF_Base,
)
from ansible_collections.arubanetworks.aoscx.plugins.module_utils.vrfs.aoscx_vrf_10_04_1000 import (  # NOQA
    VRF_10_04_1000,
)
...
class VRF:
    ...
    def get_vrf_field_value(self, aruba_ansible_module, vrf_name, field):
        """
    ...
    def update_vrf_fields(self, aruba_ansible_module, vrf_name, field, value):
        """
    ...
    def delete_vrf_field(self, aruba_ansible_module, vrf_name, field, value):
        """
